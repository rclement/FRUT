...
function(_JUCE_add_target_from_module_header module_header_file
  find_version_exact find_quietly find_required
)
  ...
  if(module_info_dependencies)
    ...
    foreach(juce_module ${dependencies})
      if(NOT ${juce_module}_FOUND)
        ...
        find_package(${juce_module} ${exact_kw} ${quiet_kw} ${required_kw})
        if(NOT ${juce_module}_FOUND)
          set(${module_info_ID}_FOUND FALSE PARENT_SCOPE)
          return()
        endif()
      endif()
    endforeach()
  ...
  set(${module_info_ID}_VERSION "${module_info_version}" PARENT_SCOPE)
