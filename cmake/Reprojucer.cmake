...
function(jucer_project_end)
  ...
  foreach(module_name ${JUCER_PROJECT_MODULES})
    ...
    if(DEFINED JUCER_PROJECT_MODULE_${module_name}_TARGET)
      ...
      if(TARGET ${module_target})
        if(NOT module_target IN_LIST modules_targets)
          message(WARNING "${module_target} already exists") # TODO: extend message
        endif()
  ...
  elseif(JUCER_PROJECT_TYPE STREQUAL "Audio Plug-in")
    ...
    foreach(src_file ${JUCER_PROJECT_SOURCES} ${modules_sources})
