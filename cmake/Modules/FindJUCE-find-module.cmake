...
if(NOT ${CMAKE_FIND_PACKAGE_NAME}_header_file STREQUAL
      "${JUCE_ROOT}/modules/${CMAKE_FIND_PACKAGE_NAME}/${CMAKE_FIND_PACKAGE_NAME}.h"
    AND NOT ${CMAKE_FIND_PACKAGE_NAME}_header_file STREQUAL
      "${JUCE_modules_DIR}/${CMAKE_FIND_PACKAGE_NAME}/${CMAKE_FIND_PACKAGE_NAME}.h")
  unset(${CMAKE_FIND_PACKAGE_NAME}_header_file CACHE)
endif()
